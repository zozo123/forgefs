...
| I19 | `forge-api/gc.rs`, `forge-store/meta.rs` (`gc_sweep`), `forge-store/blob.rs` (`refresh_dedup_mtime`) | `gc_collect_concurrent.rs`, `gc_collect.rs`, `gc_and_abandon.rs`, `cache_trust.rs`, `docs/GC.md` |
