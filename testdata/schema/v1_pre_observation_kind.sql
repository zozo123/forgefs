-- Schema version 1: the shape shipped before `observations` grew a
-- `kind` discriminant. Identical to the pre-versioning catalog except
-- that the migration ledger exists and records version 1, so `migrate`
-- takes the stepwise path rather than the pre-versioning path.
-- Frozen: do not regenerate from current code. See README.md.
